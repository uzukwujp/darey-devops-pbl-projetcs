...
- In the IAM console navigation menu, click on policy and follow the image below to creaet a new policy for the IAM role. Use the Json code snippet below for your policy
```
