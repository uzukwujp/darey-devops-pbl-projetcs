...
From our previous knowledge of EC2, launch a RedHat EC2 Instance
...
4. Navigate to the EC2 console and attach the `role` you created to your ec2 instance

![Alt text](images/attach-role.gif)

### Step 3: Install and configure CloudWatch Logs on EC2 Instance
