...
- Click on **administration**, **Repositoris** , and **Add repositories as shown in the image below.
     ...
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo1.png" width="936px" height="550px">
- Since we are exploring **Local Repositories**, select **Local Repository**
  
      <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo2.png" width="936px" height="550px">
- Type **Docker** in the search box and select the **Docker** icon

     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo3.png" width="936px" height="550px">
- In the **Repository Key** box, type in the name of the repository you wh=ish to create. For example `tooling`. So that all the docker images for tooling app can be pushed there. 
     ...
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo4.png" width="936px" height="550px">
- Click on the **Create Local Repository** button.

     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo5.png" width="936px" height="550px">
- Now you can see that a **Docker Repository** for `tooling` has been created.
  
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo6.png" width="936px" height="550px">
- Create a second **Local Repository** for `Jenkins`

     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo7.png" width="936px" height="550px">
...
- Select **virtual Repository**
    <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo8.png" width="936px" height="550px">
- Name the **virtual Repository** as you deem fit, click on the **create Virtual Repository** button

     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo9.png" width="936px" height="550px">
- Now that the virtual repository is created, it is time to add local repositories to it. You can see in the image below that it is a **virtual** repo, and it will only be used by **Docker**.
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo10.png" width="936px" height="550px">
- Scroll down the page to see the local repositories. This is where you select which local repository that will be part of the virtual repository. Click on the double arrows to move them.
     ...
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo11.png" width="936px" height="550px">
- Once moved, you will see them in the included items section.

     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo12.png" width="936px" height="550px">
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo13.png" width="936px" height="550px">
- To see the address of the virtual repository, simply click on the square icon at the top left, click on **Artifacts** and select the repository you wish to see more information on. 
    ...
    <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo14.png" width="936px" height="550px">
...
- Tag the image so that it can pushed to Artifactory. The image below shows how to get the repository URL address.
    <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/create-repo15.png" width="936px" height="550px">
  ```
...
<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/blueocean-version.png" width="936px" height="550px">
...
<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/jcasc-system-message.png" width="936px" height="550px">
...
1. Navigate to Configuration as code section in Jenkins UI. Click on **Configuration as Code**
     ...
     <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/JCasC1.png" width="936px" height="550px">
2. Click on **View Configuration**

      <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/JCasC2.png" width="936px" height="550px">
3. You will see the updated code configuration here.
         <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/JCasC3.png" width="936px" height="550px">
...
In the Jenkins values file, you will set the values correctly so that the secret created above can be used. 
   [If you click here to see the documentation in artifacthub.io](https://artifacthub.io/packages/helm/jenkinsci/jenkins?modal=values&path=controller.initScripts), as shown in the image below. 
    <img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/jenkins-secrets-values.png" width="936px" height="550px">
...
<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/jenkins-folder.png" width="936px" height="550px">
...
<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/credential-password.png" width="936px" height="550px">
...
<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/multi-pipeline-tooling1.png" width="936px" height="550px">
All the branches have automatically triggered their respective pipeliines.

<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/multi-pipeline-tooling2.png" width="936px" height="550px">
...
<img src="https://darey-io-pbl-projects-images.s3.eu-west-2.amazonaws.com/project26/JCasC4.png" width="936px" height="550px">
